...
plt.figure()
videos, models, perfs, frame_rates, accs = load_videostorm_e2e_results(
    '/data/zxxia/benchmarking/results/videostorm/mot16_e2e/videostorm_e2e_mot16.csv')
videos_to_plot.extend(videos)
perfs_to_plot.extend(perfs)
accs_to_plot.extend(accs)

videos, models, perfs, frame_rates, accs = load_videostorm_e2e_results(
    '/data/zxxia/benchmarking/results/videostorm/mot15_e2e/videostorm_e2e_mot15.csv')
videos_to_plot.extend(videos)
perfs_to_plot.extend(perfs)
accs_to_plot.extend(accs)
