...
# for VIDEO in $VIDEOS
# do
#     python ../videostorm/videostorm_overfitting.py \
#         --video $VIDEO \
#         --input /mnt/data/zhujun/dataset/Youtube/${VIDEO}/480p/profile/updated_gt_FasterRCNN_COCO.csv \
#         --metadata_file /mnt/data/zhujun/dataset/Youtube/${VIDEO}/metadata.json \
#         --output tmp.csv \
#         --log results/${VIDEO}_480p.csv \
#         --short_video_length 30 \
#         --profile_length 30 
# done
MODELS='FasterRCNN Resnet50 inception mobilenet'
VIDEO='drift'
for MODEL in $MODELS
do
    python ../videostorm/videostorm_overfitting.py \
        --video $VIDEO \
        --input /mnt/data/zhujun/dataset/Youtube/${VIDEO}/720p/profile/updated_gt_${MODEL}_COCO_no_filter.csv \
        --metadata_file /mnt/data/zhujun/dataset/Youtube/${VIDEO}/metadata.json \
        --output tmp.csv \
        --log results/${VIDEO}_720p_${MODEL}.csv \
        --short_video_length 30 \
        --profile_length 30 &
done
