...
do
    python ../videostorm/videostorm_overfitting.py \
        --video $VIDEO \
        --input /mnt/data/zhujun/dataset/Youtube/${VIDEO}/540p/profile/updated_gt_FasterRCNN_COCO_no_filter.csv \
        --metadata_file /mnt/data/zhujun/dataset/Youtube/${VIDEO}/metadata.json \
        --output tmp.csv \
        --log results/${VIDEO}_540p.csv \
...
#     python ../videostorm/videostorm_overfitting.py \
#         --video $VIDEO \
#         --input /mnt/data/zhujun/dataset/Youtube/${VIDEO}/720p/profile/updated_gt_FasterRCNN_COCO_no_filter.csv \
#         --metadata_file /mnt/data/zhujun/dataset/Youtube/${VIDEO}/metadata.json \
#         --output tmp.csv \
#         --log results/${VIDEO}_720p.csv \
#         --short_video_length 30 \
#         --profile_length 30 &
# done
