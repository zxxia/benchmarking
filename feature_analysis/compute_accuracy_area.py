...
from benchmarking.feature_analysis.helpers import load_awstream_profile, nonzero, \
    load_video_features, sample_video_features
from benchmarking.constants import COCOLabels, CAMERA_TYPES, RESOL_DICT
...
def main():
    ...
    for video in DATASET_LIST:
        ...
        metadata = load_metadata(
            '/data/zxxia/videos/{}/metadata.json'.format(video))
