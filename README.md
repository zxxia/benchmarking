...
- [ ] Refactor feature\_analysis module.
    1. [Feature generation script](feature_analysis/compute_features.py).
...
- [ ] Implement [profiler](profiler) module.
    1. Input: a user-implemented pipeline, selected video names
    2. Output: content features vs\. primitive  performance.(file format csv 
    or json)
    3. Logic: Iterate over every possible configuration and record the f1,
