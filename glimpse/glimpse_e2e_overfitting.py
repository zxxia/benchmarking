...
PARA1_DICT = {'crossroad': np.arange(10, 20, 5),
              'crossroad2': np.arange(50, 55, 5),
              'crossroad3': np.arange(50, 70, 5),
              'crossroad4': np.arange(20, 35, 5),
              'drift': np.arange(150, 350, 50),
              'driving1': np.arange(20, 25, 10),
              'driving2': np.arange(20, 100, 20),
              'driving_downtown': np.arange(10, 50, 10),
              'highway': np.arange(10, 25, 5),
              'jp': [20],  # np.arange(20, 30, 5),
              'lane_split': [10],  # np.arange(10, 20, 5),
              'motorway': [2],  # np.arange(2, 8, 2),
...
PARA2_DICT = {'crossroad': np.arange(2, 0, 1),
              'crossroad2': np.arange(4, 0, -1),
              'crossroad3': np.arange(1, 0, -0.2),
              'crossroad4': np.arange(2, 0, -1),
              'drift': np.arange(1.0, 0.6, -0.2),
              'driving1': np.arange(20, 30, 5),
              'driving2': np.arange(20, 100, 20),
              'driving_downtown': np.arange(10, 10, 10),
              'highway': np.arange(4, 0, -2),
              'jp': [0.7],  # np.arange(1, 0, -0.3),
              'lane_split': np.arange(10, 20, 5),
              'motorway': [5],  # np.arange(6, 0, -1),
              'nyc': np.arange(8, 0, -2),
...
def main():
    ...
    with open(output_file, 'w', 1) as final_result_f:
        ...
        f_profile = open('overfitting_profile/glimpse_overfitting_profile_{}.csv'.format(video_name), 'w')
