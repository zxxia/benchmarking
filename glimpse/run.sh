...
do
    ...
    python glimpse_e2e.py \
        --video $VIDEO \
        --metadata $DATA_PATH/$VIDEO/metadata.json \
        --output /data/zxxia/benchmarking/glimpse/e2e_results_bug_free/glimpse_result_${VIDEO}.csv \
        --log /data/zxxia/benchmarking/glimpse/e2e_results_bug_free/glimpse_profile_${VIDEO}.csv \
        --short_video_length $SHORT_VIDEO_LENGTH \
        --profile_length $PROFILE_LENGTH \
        --offset $OFFSET \
        --trace_path /data/zxxia/benchmarking/glimpse/e2e_results_bug_free \
        --profile_trace_path /data/zxxia/benchmarking/glimpse/e2e_results_bug_free &
done
