...
def run(args):
    ...
    classes_interested = args.classes_interested
    ...
    glimpse_temporal = Glimpse_Temporal(30, 5, 1280*720//2, 0.5)
    glimpse_model = Glimpse_Model(1280*720//2, 0.5)
    ...
    for seg_path in seg_paths:
        ...
        pipeline.run(original_video, original_video.start_frame_index(), original_video.end_frame_index())
