...
def parse_args():
    ...
    parser.add_argument("--temporal_flag", type=str2bool, default=True, 
                        help="whether this VAP use temporal pruning")
    parser.add_argument("--spatial_flag", type=str2bool, default=True, 
                        help="whether this VAP use spatial pruning")
    parser.add_argument("--model_flag", type=str2bool, default=True, 
                        help="whether this VAP use model pruning")

    parser.add_argument("--oracle_temporal", type=str, default="1", 
                        help="oracle setting of temporal pruning parameter")
    parser.add_argument("--oracle_spatial", type=str, default="720p", 
                        help="oracle setting of spatial pruning parameter")
    parser.add_argument("--oracle_model", type=str, default="faster_rcnn_resnet101", 
                        help="oracle setting of model pruning parameter")
    parser.add_argument("--temporal_list", nargs="*", type=str,
    ...
    parser.add_argument("--spatial_list", nargs="*", type=str,
                        default=['720p','540p','480p','360p'], 
                        help="A list of spatial pruning parameters. "
                        )
    parser.add_argument("--model_list", nargs="*", type=str,
                        default=['faster_rcnn_resnet101', 'faster_rcnn_inception_v2', 'ssd_mobilenet_v2'],
                        help="A list of model pruning parameters. "
                        )
    ...
    parser.add_argument("--interested_performance_list", nargs="*", type=str,
                        default=['f1', 'gpu time', 'bandwidth'], help="A list of "
                        "interested performance list. Other performance will be filtered "
                        "out. Default ['f1', 'gpu time','bandwidth'].")
