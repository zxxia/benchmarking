...
def main():
    with open('videostorm_coverage_kitti.csv', 'w') as f:
        ...
        for dataset in DATASET_LIST:
            ...
            gt_file = PATH + dataset + '/2011_09_26_drive_' + \
                ...
                '_sync/Parserd_ground_truth.csv'
            ...
            best_frame_rate = profile(gt, gt, start_frame, end_frame,
            ...
            for i, video_idx in enumerate(VIDEO_INDEX_DICT[dataset]):
                if video_idx == profiling_video_idx:
                    continue
                gt_file = PATH + dataset + '/2011_09_26_drive_' + \
                    format(video_idx, '04d') + '_sync/result/input_w_gt.csv'
                dt, gt, img_list = load_ssd_detection(gt_file)
                print(gt_file)
