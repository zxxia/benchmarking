...
CHUNK_LENGTH = int(30) # A long video is chopped into chunks. Unit: second
PROFILE_LENGTH = 10 # Profiling length within a chunk. Unit: second

def main():
    with open('videostorm_t_crossroad_coverage_profile_10s.csv', 'w') as f:
        ...
        for dataset in DATASET_LIST:
            ...
            gt_file = PATH + dataset + '/' + str(resolution[1]) + 'p/profile/updated_gt_FasterRCNN_COCO.csv'
            ...
            for i in range(num_of_chunks):
                ...
                best_frame_rate = profile(gt, gt, profile_start_frame, profile_end_frame,
