...
DATASET_LIST = ['highway_no_traffic']
IOU_THRESH = 0.5
TARGET_F1 = 0.9
OFFSET = 1 # The time offset from the start of the video. Unit: seconds
CHUNK_LENGTH = int(1*60) # A long video is chopped into chunks. Unit: second
...
def main():
    ...
    for dataset in DATASET_LIST:
        ...
        with open('videostorm_motivation_result_{}.csv'.format(dataset),'w') as f:
