...
def main(argv):
    ...
    frame_rate = metadata['frame rate']# FLAGS.frame_rate#frame_rate_dict[video_name]
    image_resolution = metadata['resolution'] #[int(x) for x in FLAGS.resol.split(',')]#image_resolution_dict[video_name]
    ...
    para_file = current_path + 'Video_features_' + video_name + '.csv'
